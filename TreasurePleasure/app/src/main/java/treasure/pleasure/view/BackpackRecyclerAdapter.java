...
/**
 * Support class for BackpackFragment, which is of type RecyclerViewFragment. Responsible for
 * providing views that represent items in a data set. Uses backpack_item_template.xml as a
 * template, and replaces text and resourcepath of that view to represent each item.
 *
 ...
 * @author David & John
 */
public class BackpackRecyclerAdapter extends
    RecyclerView.Adapter<BackpackRecyclerAdapter.MyViewHolder> {
  ...
  public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View view = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.backpack_item_template, parent, false);
