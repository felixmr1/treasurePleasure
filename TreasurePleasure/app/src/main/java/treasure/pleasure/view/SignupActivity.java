...
public class SignupActivity extends BaseActivity<SignupPresenter> {
  ...
  /**
   * Onpress event when submit button is clicked. lets the presenter handle the logic and call
   * methods depending on what happens within business logic.
   */
  ...
  /**
   * Called if a exception is fired within the business logic and lets the user see this. Shows the
   * exception message in form of a toast.
   *
  ...
  /**
   * superclass will call this in its constructor. Has to be implemented to make sure the
   * constructor gives correct imoplementatiopn of Basepresenter
   *
